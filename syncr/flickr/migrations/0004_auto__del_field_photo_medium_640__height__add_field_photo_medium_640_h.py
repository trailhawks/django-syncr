...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.medium_640_height'
        db.add_column('flickr_photo', 'medium_640_height', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Photo.medium_640_height'
        db.delete_column('flickr_photo', 'medium_640_height')
