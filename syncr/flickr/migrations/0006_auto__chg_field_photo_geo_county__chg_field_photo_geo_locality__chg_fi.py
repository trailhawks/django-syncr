...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Photo.geo_county'
        db.alter_column('flickr_photo', 'geo_county', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Photo.geo_locality'
        db.alter_column('flickr_photo', 'geo_locality', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Photo.geo_region'
        db.alter_column('flickr_photo', 'geo_region', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Photo.geo_country'
        db.alter_column('flickr_photo', 'geo_country', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Photo.geo_county'
        db.alter_column('flickr_photo', 'geo_county', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Photo.geo_locality'
        db.alter_column('flickr_photo', 'geo_locality', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Photo.geo_region'
        db.alter_column('flickr_photo', 'geo_region', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Photo.geo_country'
        db.alter_column('flickr_photo', 'geo_country', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
    ...
    models = {
        ...
        'flickr.photo': {
            ...
            'geo_country': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'geo_county': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'geo_latitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'geo_locality': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'geo_longitude': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'geo_region': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
