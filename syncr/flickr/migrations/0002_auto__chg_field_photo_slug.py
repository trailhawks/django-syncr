...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('flickr_photo', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=100))

    def backwards(self, orm):
        # Changing field 'Photo.slug'
        db.alter_column('flickr_photo', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50))
