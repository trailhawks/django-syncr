...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.medium_640_width'
        db.add_column('flickr_photo', 'medium_640_width', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True), keep_default=False)

        # Adding field 'Photo.medium_640__height'
        db.add_column('flickr_photo', 'medium_640__height', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.medium_640_width'
        db.delete_column('flickr_photo', 'medium_640_width')

        # Deleting field 'Photo.medium_640__height'
        db.delete_column('flickr_photo', 'medium_640__height')
    ...
    models = {
        ...
        'flickr.photo': {
            ...
            'medium_640__height': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
