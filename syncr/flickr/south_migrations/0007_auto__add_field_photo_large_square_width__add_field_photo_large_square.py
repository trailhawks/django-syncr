...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.large_square_width'
        db.add_column('flickr_photo', 'large_square_width',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Photo.large_square_height'
        db.add_column('flickr_photo', 'large_square_height',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.large_square_width'
        db.delete_column('flickr_photo', 'large_square_width')

        # Deleting field 'Photo.large_square_height'
        db.delete_column('flickr_photo', 'large_square_height')
    ...
    models = {
        ...
        'flickr.photo': {
            ...
            'large_square_height': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
            'large_square_width': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
